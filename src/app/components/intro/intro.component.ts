...
@Component({
  ...
  imports: [],
  template: `
    <section id="intro" class="h-[100dvh] grid place-items-center text-center">
      <div
      ...
      >
        ...
        >
          ...
          <div class="flex flex-col items-center">
            <p class="uppercase text-xs">Fotos</p>
            <a
              (click)="displayAlert()"
              class="transition-colors rounded-full grid place-items-center bg-[#643f26]/40 active:bg-[#643f26] hover:bg-[#c97c48] p-2 w-12 h-12"
            >
...
export class IntroComponent {
  ...
  displayAlert() {
    alert("Em breve colocaremos as fotos e vídeos do casamento");
  }
}
